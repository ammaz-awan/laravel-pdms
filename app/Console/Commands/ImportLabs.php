...
class ImportLabs extends Command
{
    ...
    protected $signature = 'labs:import
                            {city : The city to search medical laboratories in}
                            {state : The 2-letter state code or state name}
                            {--limit= : Maximum number of unique medical laboratories to import}
     ...
     * @var string
     */
    protected $description = 'Import and normalize medical/diagnostic laboratory listings from Google Maps for a given city and state';

    /**
     * Execute the console command.
     */
    public function handle(LabImportService $importer): int
    {
        ...
        $this->info("=================================================");
        $this->info("          Laboratory Directory Importer          ");
        $this->info("=================================================");
        ...
        $this->line("Fetching and processing medical laboratories from Google Maps...");
        ...
        if ($dryRun) {
            ...
            $this->warn("No medical laboratory listings were found or imported for {$stats['city']}.");
        } else {

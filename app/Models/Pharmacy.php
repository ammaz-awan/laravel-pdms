...
class Pharmacy extends Model
{
    ...
    /**
     * Clean messy testing/kiosk/drive-thru/screening prefixes and suffixes to return the pure relative pharmacy business name.
     */
    public static function cleanDisplayName(?string $name): string
    {
        ...
        // 1. Remove leading service/testing/screening/kiosk prefixes (e.g. "COVID-19 Drive-Thru Testing at Walgreens" -> "Walgreens")
        $clean = preg_replace(
        ...
        // 2. Remove parenthetical or bracketed service descriptions (e.g. "Walgreens (Drive-thru Testing)" -> "Walgreens")
        $clean = preg_replace(
